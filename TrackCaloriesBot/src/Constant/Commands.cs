...
public static class Commands
{
    ...
    public const string ShowUserInfoCommand = "Info about me";
    public const string NewRecordCommand = "New record";
    ...
    public const string ShowMyRecipesCommand = "Show my recipes";
